...
export default {
  ...
  rolemgt: {
    ...
    inputrule: 'Only numbers,letters and underscore are allowed',
    tenantcheckedfirst: '"Manage tenants" should be checked first. Otherwise, it will not take effect',
  },
  usermgt: {
    accountrule: 'Only number, uppercase letter, lowercase letter and underscores are allowed',
    ...
    passwdlen: 'Make sure it\'s at least 8 characters and no more than 16 characters',
    passwdrule: 'and only number, uppercase letter, lowercase letter and special characters (~! @ # $% ^&* _.?) are allowed, and at least two or more types',
  ...
  volume: {
    ...
    volumenamerule: 'Must start with letters, and can contains underscore, number, letter or short dash',  
  },
  tenant: {
    createtenantsuc: 'Create tenant successfully',
    idrule: 'Must start with letters, and can contains underscore, number or letter',
